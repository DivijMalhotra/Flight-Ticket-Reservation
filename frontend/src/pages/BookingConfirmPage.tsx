...
import { CheckCircle, Search, ClipboardList, Plane } from 'lucide-react';
...
const BookingConfirmPage: React.FC = () => {
  ...
  return (
    <>
      {/* Hero glow */}
      <section className="relative bg-surface-primary pt-10 pb-20 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-green-500/[0.05] rounded-full blur-[100px]" />
          <div className="absolute bottom-0 right-0 w-[300px] h-[200px] bg-brand-500/[0.03] rounded-full blur-[80px]" />
        </div>
      </section>

      <div className="container-app -mt-24 relative z-10 pb-12">
        <motion.div
            ...
            <div className="bg-surface-primary rounded-xl border border-white/5 overflow-hidden mb-6">
              ...
              <div className="p-5 space-y-3 text-left">
                {[
                  ...
                  ['Price', formatCurrency(Number(ticket?.Price) || 0)],
